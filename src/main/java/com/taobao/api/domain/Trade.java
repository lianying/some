...
public class Trade extends TaobaoObject {
	...
	private static final long serialVersionUID = 5622615449133745793L;
...
用户取消物流订单 CANCELED
	...
	/**
	 * 是否保障速递，如果为true，则为保障速递订单，强制流转到物流宝发货，如果未false，则该订单非保障速递，根据卖家设置的订单流转规则可使用物流宝或者常规物流发货。
	 */
	@ApiField("is_lgtype")
...
step (万人团)
	...
	public Long getYfxType() {
		return this.yfxType;
	}
	public void setYfxType(Long yfxType) {
